...
def fit_lgbm(X, y, n, seed, _est=None):
    ...
    # subsample is inert: bagging_freq defaults to 0. Kept as the call that built the archives.
...
def fit_mlp(X, y, per, seed):
    ...
    # oversampling is a choice, not an API limit (fit accepts sample_weight since scikit-learn 1.7); learning_rate is ignored by adam. Kept as the call that built the archives.
